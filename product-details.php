...
$pro_1 = mysqli_fetch_assoc($result)
?>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="product-images">
                        <main id="gallery">
                            <div class="main-img">
                                <img src="admin/images/<?php echo $pro_1["image"] ?>" id="current" alt="#">
                            </div>
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="product-info">
                        <h2 class="title"><?php echo $pro_1["name"] ?></h2>
                        <h2 class="title">Quantity   <u><?php echo $pro_1["quantity"] ?></u></h2>
                        <p class="bg bg-black"><?php echo $pro_1["cat"] ?></p>
                        <p class="category"><i class="lni lni-tag"></i> Drones:<a href="javascript:void(0)">Action
                                cameras</a></p>
                        <h3 class="price">$<?php echo $pro_1["price"] ?><span>$<?php echo $pro_1["old_price"] ?></span>
                        </h3>
                        <p class="info-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                            tempor incididunt
                            ut labore et dolore magna aliqua.</p>
                       
                        <form action="handel_cart.php?id=<?php echo $id ?>" method="POST">
                        <?php
                            if (isset($_SESSION["error_quantity"])) { ?>
                                <div class="alert alert-danger" role="alert">
                                    <?php echo $_SESSION["error_quantity"]; ?>
                                </div>
                            <?php }
